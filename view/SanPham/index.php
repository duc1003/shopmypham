...
if (isset($_GET["id"])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["add_to_cart"], $_POST["product_id"], $_POST["name"], $_POST["price"], $_POST["quantity"])) {
        ...
        if (isset($_SESSION["cart"][$product_id])) {
            ...
            $_SESSION["cart"][$product_id] = [
                ...
                "price" => $price,
                "quantity" => $quantity,
                "image_url" => $r["image_url"] // ✅ Đặt đúng ở đây
            ];
        }
    ...
    echo "<input type='hidden' name='name' value='" . $r["name"] . "'>";
